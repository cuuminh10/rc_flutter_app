...
class FavorDetailScreen extends GetView<FavorDetailController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
          () => controller.favorDetailResponse.value.id != null ? SafeArea(
        child: Scaffold(
          ...
          appBar: CommonWidget.appBar(
            ...
            customAction: Align(
              ...
              child: GestureDetector(
                child: Text(controller.infoScreen['actionAppbBar'], style: TextStyle(fontSize: 16.0, color: ColorConstants.Blue500, fontWeight: FontWeight.bold),),
              ),
            )
          ),
              ...
              child: Column(
                ...
                children: <Widget>[
                    ...
                    children: [
                      Container(
                        ...
                        child: Padding(
                          ...
                          child: GmcLabel(
                            label: controller.favorDetailResponse.value.no,
                      ...
                      Container(
                        decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(
                                color: ColorConstants.Gray6, spreadRadius: 1),
                          ],
                        ),
                        child: Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: GmcLabel(
                            label: controller.favorDetailResponse.value.woNo,
                            color: ColorConstants.Blue800,
                            fontSize: 14.0,
                  ...
                  Align(
                    ...
                    child: GmcLabel(
                      label: controller.favorDetailResponse.value.jobTicketNo,
                    ...
                    children: <Widget>[
                      Flexible(
                          child: GmcTiles(
                            ...
                            labelExpandedValue: controller.infoScreen['label_topLeft'],
                            labelSubTittleValue: controller.favorDetailResponse.value.phaseNo,
                      ...
                      Flexible(
                          child: GmcTiles(
                            colorIcon: ColorConstants.darkHeading,
                            labelExpandedValue: controller.infoScreen['label_topRight'],
                            labelSubTittleValue: controller.favorDetailResponse.value.workCenterName,
                  ...
                  Row(
                    children: <Widget>[
                      Flexible(
                          child: GmcTiles(
                            colorIcon: ColorConstants.darkHeading,
                            labelExpandedValue: controller.infoScreen['label_bottomLeft'],
                            ...
                            colorBorder: ColorConstants.warning,
                            widgetLeading: Text(
                              helper.cutName(controller.favorDetailResponse.value.employeeName),
                              style:
                      ...
                      Flexible(
                          child: GmcTiles(
                            colorIcon: ColorConstants.darkHeading,
                            labelExpandedValue: controller.infoScreen['label_bottomRight'],
                            labelSubTittleValue: helper.ConvertDateTime(controller.favorDetailResponse.value.ordDate),
          ...
          bottomNavigationBar:controller.selectedPage == 1 ? Transform.translate(
            ...
            child: Container(
              ...
              child: BottomAppBar(
                child: Row(
                  ...
                  children: [
                    const GmcButtonSvg(iconSvg: 'assets/svg/mention.svg'),
                    GmcSpace(
                      width: SizeConfig().screenWidth * 0.01,
                    ),
                    const GmcButtonSvg(iconSvg: 'assets/svg/attach.svg'),
                    GmcSpace(
                      width: SizeConfig().screenWidth * 0.01,
                    ),
                    const GmcButtonSvg(iconSvg: 'assets/svg/camera.svg'),
                    Expanded(
                      child: Container(
                        padding: EdgeInsets.all(controller.reply.value.trim().isEmpty ? 0.0 : 8.0),
                        decoration: BoxDecoration(
                        ...
                        child: Column(
                          mainAxisSize: MainAxisSize.min,
                          children: [
                            if (controller.reply.value.trim().isNotEmpty)
                              Row(
                            ...
                            GmcInputField(
                              ...
                              placeholder: 'Aa',
                              borderNone :controller.reply.value.trim().isEmpty ? false : true,
                              fontSize: 18.0,
                              onChange: (text) {},
                            )
                          ],
                    ...
                    Container(
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            gradient: gradient(controller.isOnChange.value),
